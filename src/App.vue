<template>
	<div id="app">
		...
		<el-button
			...
			size="small"
		>退出预览</el-button>
		<router-view @signinsuccess="signinsuccess" @signupsuccess="signupsuccess"></router-view>
	</div>
</template>
	...
	export default {
		...
		data() {
			return {
				...
				resume: {
					...
					project: [
						{
							projectName: "vue简历编辑器（在线版）",
							code: "",
							preview: "",
							skill: "vue",
							projectContent: "请简单介绍你的项目"
						}
					],
					skills: [{ name: "vue", master: "熟悉", content: [{ name: "" }] }]
				},
				currentUser: {
					userName: "",
					userEmail: "",
		...
		methods: {
			...
			save() {
				...
				var user = AV.Object.createWithoutData(
					"_User",
					this.currentUser.objectId
				);
				// 修改属性
